  ...
  return (
   ...
   {!isAtDropLocation&&(
        <div className="h-[20vh] w-full bg-white border-t text-black flex flex-col items-center justify-center px-4 shadow-inner z-30">
          <p className="text-lg font-semibold">Drop location</p>
          ...
          <button
            ...
            onClick={handleReachDroplocation}
            className="text-blue-600 underline text-sm"
          >
            Simulate Reached Drop
          </button>
        </div>
   )}
...
export default GoingForDropLocation;